import allure
from pages.web_page.add_markers3 import LogHome
...
class TestLogHome(object):
    ...
    def test_home(self,browser):
        ...
        wb = xlrd.open_workbook('D:\\auto_test\\test3.xls')
        ...
        for i in range(sh.nrows):
            ...
            elif(sh.row_values(i)[1]=="Human"or  sh.row_values(i)[1]=="Human/Non-Human Primate"):
            ...
            try:
                ...
                if (sh.row_values(i)[4][-1] == '\xa0'):
                    assert page.driver.find_elements_by_xpath("//*[@type ='text']")[3].get_attribute("value") == \
                           sh.row_values(i)[4][:-1]
                else:
                    assert page.driver.find_elements_by_xpath("//*[@type ='text']")[3].get_attribute("value") == \
                           sh.row_values(i)[4]
                ...
                if (sh.row_values(i)[4][-1] == '\xa0'):
                    assert page.driver.find_elements_by_xpath("//*[@type ='text']")[2].get_attribute("value") == \
                           sh.row_values(i)[4][:-1]
                else:
                    assert page.driver.find_elements_by_xpath("//*[@type ='text']")[2].get_attribute("value") == \
                           sh.row_values(i)[4]
